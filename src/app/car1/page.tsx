    ...
    return (
        <div>
            <div className="flex justify-center items-center my-20">
                <h1 className="font-semibold text-3xl underline">Toyota Carolla 2024 Price in  Pakistan,Images,Reviews,& Specs</h1></div>
            ...
            <div className="flex justify-center space-x-2 py-5">
                <h1 className="text-green-600 text-2xl"> PKR 59.7 - 75.5 lacs</h1>
            </div >
            <div className="flex justify-center space-x-6 py-10">
