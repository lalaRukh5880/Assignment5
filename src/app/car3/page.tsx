    ...
    return (
        <div>
            <div className="flex justify-center items-center my-20">
                <h1 className="font-semibold text-3xl underline">Changan Alsvin 2024 Price in  Pakistan,Images,Reviews,& Specs</h1></div>
            <div className="flex justify-center my-25">
                <img src="car 3 Alsvin_-_PNG (1).png" className="h-80 w-70" />
            </div>
            ...
            <div className="flex justify-center space-x-2 py-5">
                <h1 className="text-green-600 text-2xl"> PKR 38.0 - 45.7 lacs</h1>
            </div >
            <div className="flex justify-center space-x-6 py-10">
